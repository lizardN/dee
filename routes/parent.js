...
router.get('/pass',isLoggedIn,parent, (req, res) => {
  var pro = req.user
    User.findById(req.user._id, (err, doc) => {
        if (!err) {
            res.render("hurlings/parents/change", {
  ...
  var errors = req.validationErrors();
   ...
   if (errors) {
      ...
      res.render('hurlings/parents/change',{ title: 'User Update', user:req.body, errors:req.session.errors, pro:pro
     })
  ...
  User.findOneAndUpdate({_id:req.body._id},req.body,
   { new: true }, (err, doc) => {
      if (!err) {
        ...
        res.render('hurlings/parents/change',{message:req.session.message, user:req.user, pro:pro
         }); }
      else {
 ...
 console.log(arr,'arr')
    ...
    res.render('messagesParents/reply',{list:docs,id:id, arr:arr, subject:sub,num:num,sent:sent,pro:pro})
              ...
              router.get('/profile',isLoggedIn, function(req,res){
                ...
                //var pro = req.user
                res.render('hurlings/parents/overview3',{doc:doc[0],id:id,pro:doc[0]})
                ...
                router.get('/files',isLoggedIn,function(req,res){
                  ...
                  var uid = req.user.studentId
                    ...
                    res.render('hurlings/parents/fileAssgtReports',{pro:pro,listX:docs})
                ...
                router.get('/pictures',isLoggedIn,function(req,res){
                  ...
                  var uid = req.user.studentId
                    ...
                    res.render('hurlings/parents/filesMonthly',{pro:pro,listX:docs})
                ...
                router.get('/filesP',isLoggedIn,function(req,res){
                  ...
                  var uid = req.user.studentId
                    ...
                    res.render('hurlings/parents/filesP',{pro:pro,listX:docs})
