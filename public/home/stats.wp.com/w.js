! function(t) {
    ...
    var o = null,
            ...
            if (null == o) {
                ...
                if ("undefined" != typeof TRACKS_COOKIE_DOMAIN) o = TRACKS_COOKIE_DOMAIN;
                    ...
                    for (var n = 1; n <= e.length; ++n)
                        if (t = "." + e.slice(-n).join("."), r = t, i = void 0, i = (new Date).getTime(), document.cookie = encodeURIComponent("tk_tc") + "=" + i + "; domain=" + r + "; path=/;", a("tc") == i) {
                            o = t;
                            break
                        }
                "" != o && (! function(t) {
        ...
        i = function(t, e, n) {
            var o = encodeURIComponent("tk_" + t),
                i = new Date;
            void 0 === n && (n = 15768e4), document.location.hostname.match(/((^|\.)wp\.com$|^.?w\.org$)/) || (i.setTime(i.getTime() + 1e3 * n), document.cookie = o + "=" + encodeURIComponent(e) + r() + "; path=/; expires=" + i.toUTCString())
        },
        a = function(t) {
            ...
            for (1 === r && (r = (o = document.cookie.split(";")).length), r--; r >= 0; r--)
                if (o[r].substring(0, n) === e) return decodeURIComponent(o[r].substring(n));
            return null
        }
}, function(t, e, n) {
    "use strict";
    ...
    function v() {
        c = void 0, u = null, d = null, [], f = null, s = {}, l = {}, p = {}, m = {}
    }
    v();
    var w = function(t) {
    ...
    var h = function(t) {
            t._ui || t._ut || C(), j(), t._ui = t._ui || c, t._ut = t._ut || u, d && (t._ul = d);
            var e = new Date;
            ...
            t._sx = void 0 !== i ? i : 0, t._sy = void 0 !== a ? a : 0, void 0 !== document.location && (t._dl = document.location.toString()), void 0 !== document.referrer && (t._dr = document.referrer),
                function t(e, n) {
                    if (null == e || "object" !== r()(e)) return e;
                    for (var o in null != n && "object" === r()(n) || (n = e.constructor()), e) e.hasOwnProperty(o) && (n[o] = t(e[o]));
                    return n
                }(l, t), y(function(t) {
                    var e = [];
        ...
        y = function(t, e) {
            if (!navigator.userAgent.match(/wp-e2e-tests|bingbot|bot|borg|google(^tv)|yahoo|slurp|msnbot|msrbot|openbot|archiver|netresearch|lycos|scooter|altavista|teoma|gigabot|baiduspider|blitzbot|oegp|charlotte|furlbot|http%20client|polybot|htdig|ichiro|mogimogi|larbin|pompos|scrubby|searchsight|seekbot|semanticdiscovery|silk|snappy|speedy|spider|voila|vortex|voyager|zao|zeal|fast\-webcrawler|converacrawler|dataparksearch|findlinks|crawler|Netvibes|Sogou Pic Spider|ICC\-Crawler|Innovazion Crawler|Daumoa|EtaoSpider|A6\-Indexer|YisouSpider|Riddler|DBot|wsr\-agent|Xenu|SeznamBot|PaperLiBot|SputnikBot|CCBot|ProoXiBot|Scrapy|Genieo|Screaming Frog|YahooCacheSystem|CiBra|Nutch/) && !(t in p))
                if (p[t] = !0, window.fetch && e) g(t), fetch("//pixel.wp.com/t.gif?" + t + "&_rt=" + (new Date).getTime() + "&_=_", {
                    mode: "no-cors",
                    keepalive: !0
                }).then(function() {
                    _(t)
                    ...
                    var n = new Image;
                    g(t), n.query = t, n.onload = function() {
        ...
        O = function(t) {
            return Object(i.a)(t) || s[t]
        },
        k = function(t, e, n) {
            s[t] = n <= -1 ? null : e, Object(i.b)(t, e, n)
        },
        I = function() {
            var t = [],
                e = O("ai"),
        ...
        C = function() {
            ...
            if (!c) {
                var e = O("ai");
                e ? (c = e, u = "anon") : t && (c = x(), u = "anon", k("ai", c))
            }
        },
        T = {
            ...
            identifyUser: function(t, e) {
                if (e && (d = e), "0" != t && "" != t && null != t && c != t) {
                    c = t, u = "wpcom:user_id";
                    for (var n = I(), o = 0; o < n.length; o++) h({
                        _en: "_aliasUser",
                        anonId: n[o]
                    });
                    var r = O("ai");
    ...
    function E() {
        return v(), window._tkq = window._tkq || [], window._tkq.a || (j(), window._tkq = new w(window._tkq)), T
    }
}, function(t, e, n) {
    var o = n(10),
        r = n(11),
    ...
    window.wpcom = window.wpcom || {}, window._tkq = window._tkq || [], window._stq = window._stq || [], Array.prototype.forEach || (Array.prototype.forEach = function(t, e) {
        ...
        var t, e, n, o, i, c, u, d = (n = function(t, e, n) {
                "function" == typeof t.addEventListener ? t.addEventListener(e, n) : "object" === a()(t.attachEvent) && t.attachEvent("on" + e, n)
            }, o = function(t) {
                return "object" === a()(t) && t.target ? t.target : window.event.srcElement
            }, i = function(t) {
                var e = 0;
                "object" === ("undefined" == typeof InstallTrigger ? "undefined" : a()(InstallTrigger)) && (e = 100), 7 === f() && (e = 100), u(o(t), e)
            }, c = function(t) {
                u(o(t), 0)
            }, u = function(n, o) {
                try {
                    ...
                    if (window._stq.push(["click", {
                        ...
                        for (var r = new Date, i = r.getTime() + o; !((r = new Date).getTime() > i););
                } catch (t) {}
            }, {
                init: function(o, r) {
                    t = o, e = r, document.body ? (n(document.body, "click", i), n(document.body, "contextmenu", c)) : document && (n(document, "click", i), n(document, "contextmenu", c))
                }
            }),
            f = function() {
                var t = 0;
                if ("object" === ("undefined" == typeof navigator ? "undefined" : a()(navigator)) && "Microsoft Internet Explorer" == navigator.appName) {
            ...
            l = function(t, e, n) {
                var o = new Image;
                o.src = document.location.protocol + "//pixel.wp.com/" + t + "?" + e + "&rand=" + Math.random(), o.alt = "", "string" == typeof n && document.body && (o.id = n, p(n), document.body.appendChild(o))
            },
            p = function(t) {
                var e = document.createElement("style");
                e.innerHTML = "img#".concat(t, " {\n			position: absolute !important;\n			clip: rect(0, 0, 0, 0);\n			padding: 0 !important;\n			border: 0 !important;\n			height: 0 !important;\n			width: 0 !important;\n			overflow: hidden;\n		}"), document.body && document.body.appendChild(e)
            },
            m = function(t) {
                if (this.a = 1, t && t.length)
                    for (var e = 0; e < t.length; e++) this.push(t[e])
        ...
        var v, w = function() {
                    ...
                    try {
                        if ("undefined" != typeof window && window.location) {
                            var e = new URL(window.location.href).searchParams,
                                n = e && Array.from(e.entries()).filter(function(t) {
                            ...
                            t = i ? Object.fromEntries(i) : t, t = Object.assign(t, o)
                        }
                    } catch (t) {
            ...
            y = function t() {
                document.hidden || (document.removeEventListener("visibilitychange", t), w())
            };
        return 6 === f() && "complete" !== document.readyState && "object" === a()(document.attachEvent) ? document.attachEvent("onreadystatechange", function(t) {
            "complete" === document.readyState && window.setTimeout(w, 250)
        }) : (v = "unknown", void 0 === document.visibilityState || "visible" !== document.visibilityState && "hidden" !== document.visibilityState && "prerender" !== document.visibilityState && "unloaded" !== document.visibilityState || (v = document.visibilityState), h.extra({
            "x_stats-initial-visibility": v
        }), void 0 !== document.hidden && document.hidden ? document.addEventListener("visibilitychange", y) : w()), h
