...
jQuery(".wpcf7-intl-tel").each(function() {
    var t = jQuery(this),
        n = {},
        e = {};
    null != t.data("preferredcountries") && "" != t.data("preferredcountries") && (n.preferredCountries = t.data("preferredcountries").split("-")), e = null != t.data("initialcountry") && "" != t.data("initialcountry") ? t.data("initialcountry") : "auto";
    var r = {
        initialCountry: e,
        utilsScript: wpcf7_utils_url,
        geoIpLookup: function(t) {
            jQuery.get("//extreme-ip-lookup.com/json", function() {}, "jsonp").always(function(n) {
