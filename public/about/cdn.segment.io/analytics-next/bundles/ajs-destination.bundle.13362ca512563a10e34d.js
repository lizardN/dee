        ...
        3162: function(t, n, i) {
            ...
            function b(t, n, i, r) {
                return (0, e.mG)(this, void 0, Promise, (function() {
                    ...
                    return (0, e.Jh)(this, (function(d) {
                        switch (d.label) {
                            case 0:
                                o = y(n), s = w(o, r), a = (0, g.Kg)(), u = "".concat(a, "/integrations/").concat(null != s ? s : o, "/").concat(i, "/").concat(null != s ? s : o, ".dynamic.js.gz"), d.label = 1;
                            case 1:
            ...
            var k = function() {
                function t(t, n, i, r, o, s) {
                    void 0 === r && (r = {}), this.options = {}, this.type = "destination", this.middleware = [], this._ready = !1, this._initialized = !1, this.flushing = !1, this.name = t, this.version = n, this.settings = (0, e.pi)({}, r), this.disableAutoISOConversion = o.disableAutoISOConversion || !1, this.integrationSource = s, this.settings.type && "browser" === this.settings.type && delete this.settings.type, this.options = o, this.buffer = o.disableClientPersistence ? new f.Z(4, []) : new v.$(4, "".concat(i, ":dest-").concat(t)), this.scheduleFlush()
                }
                        ...
                        return (0, e.Jh)(this, (function(v) {
                            switch (v.label) {
                                case 0:
                                    ...
                                    if (s = null === (o = null === (r = this.options) || void 0 === r ? void 0 : r.plan) || void 0 === o ? void 0 : o.track, u = t.event.event, s && u && "Segment.io" !== this.name) {
                                        if (c = s[u], !(0, l.n)(s, c)) return t.updateEvent("integrations", (0, e.pi)((0, e.pi)({}, t.event.integrations), {
                                            All: !1,
                                            "Segment.io": !0
                                        })), t.cancel(new a.Y({
                                            retry: !1,
                                        ...
                                        if (t.updateEvent("integrations", (0, e.pi)((0, e.pi)({}, t.event.integrations), null == c ? void 0 : c.integrations)), (null == c ? void 0 : c.enabled) && !1 === (null == c ? void 0 : c.integrations[this.name])) return t.cancel(new a.Y({
                                            retry: !1,
                                            reason: "Event ".concat(u, " disabled for integration ").concat(this.name, " in tracking plan"),
                                            type: "Dropped by plan"
                                        })), [2, t]
                    ...
                    this.flushing || setTimeout((function() {
                        return (0, e.mG)(t, void 0, void 0, (function() {
                            ...
                            return (0, e.Jh)(this, (function(n) {
                                switch (n.label) {
                                    case 0:
                                        return this.flushing = !0, t = this, [4, z(this, this.buffer)];
                                    case 1:
            ...
            function G(t, n, i, r, o, s) {
                ...
                var l = null !== (c = null === (a = n.middlewareSettings) || void 0 === a ? void 0 : a.routingRules) && void 0 !== c ? c : [],
                    ...
                    g = new Set((0, e.ev)((0, e.ev)([], Object.keys(h).filter((function(t) {
                        return function(t, n) {
                            var i, e = n.type,
                                r = n.bundlingStatus,
                                o = n.versionSettings,
                        ...
                        return (0, _.PO)(h[t]) || (0, _.PO)(null == f ? void 0 : f[t])
                    })), !0));
