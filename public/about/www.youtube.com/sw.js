...
ytcfg.set({
    "EXPERIMENT_FLAGS": {
        ...
        "graft_gum_response_to_logging_screen": true,
    ...
    "INNERTUBE_CLIENT_VERSION": "2.20240111.09.00",
    "INNERTUBE_CONTEXT": {
        "client": {
            "hl": "en",
            "gl": "ZW",
    ...
    "INNERTUBE_CONTEXT_CLIENT_VERSION": "2.20240111.09.00",
...
if (self.trustedTypes && self.trustedTypes.createPolicy) {
    var policy = self.trustedTypes.createPolicy('youtubeServiceWorkerPolicy', {
        createScriptURL: function(unused) {
            return 'https:\/\/www.youtube.com\/s\/desktop\/7197d3dc\/jsbin\/serviceworker-kevlar-appshell.vflset\/serviceworker-kevlar-appshell.js';
        }
    });
    importScripts(policy.createScriptURL(''));
} else {
    importScripts('https:\/\/www.youtube.com\/s\/desktop\/7197d3dc\/jsbin\/serviceworker-kevlar-appshell.vflset\/serviceworker-kevlar-appshell.js');
}