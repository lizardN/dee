(() => {
    var e, t, r = {
                ...
                ! function(e) {
                    ...
                    function i(e) {
                        var n = "[A-Za-z]",
                            ...
                            q = r(M + L),
                            V = "(?!" + D + ")",
                            K = (r(L + "|" + F + "|" + z + "|" + q + "|" + V), r(r(D + "|" + t("[\\/\\?]", u)) + "*")),
                            H = r(r(D + "|[\\/\\?]") + "*"),
                            B = r(r("\\/\\/" + A + L) + "|" + F + "|" + q + "|" + V),
                            G = r(l + "\\:" + B + r("\\?" + K) + "?" + r("\\#" + H) + "?"),
                            J = r(r("\\/\\/" + A + L) + "|" + F + "|" + z + "|" + V),
                            W = r(J + r("\\?" + K) + "?" + r("\\#" + H) + "?");
                        return r(G + "|" + W), r(l + "\\:" + B + r("\\?" + K) + "?"), r(r("\\/\\/(" + r("(" + f + ")@") + "?(" + C + ")" + r("\\:(" + I + ")") + "?)") + "?(" + L + "|" + F + "|" + q + "|" + V + ")"), r("\\?(" + K + ")"), r("\\#(" + H + ")"), r(r("\\/\\/(" + r("(" + f + ")@") + "?(" + C + ")" + r("\\:(" + I + ")") + "?)") + "?(" + L + "|" + F + "|" + z + "|" + V + ")"), r("\\?(" + K + ")"), r("\\#(" + H + ")"), r(r("\\/\\/(" + r("(" + f + ")@") + "?(" + C + ")" + r("\\:(" + I + ")") + "?)") + "?(" + L + "|" + F + "|" + q + "|" + V + ")"), r("\\?(" + K + ")"), r("\\#(" + H + ")"), r("(" + f + ")@"), r("\\:(" + I + ")"), {
                            ...
                            IPV6ADDRESS: new RegExp("^\\[?(" + O + ")" + r(r("\\%25|\\%(?!" + s + "{2})") + "(" + k + ")") + "?\\]?$")
                        }
                    }
                    var c = i(!1),
                        u = i(!0),
                    ...
                    var C = function(e) {
                        ...
                        A = function(e, t, r) {
                            var n = 0;
                            for (e = r ? O(e / v) : e >> 1, e += O(e / t); e > P * m >> 1; n += h) e = O(e / P);
                        ...
                        D = function(e) {
                            var t = [],
                                ...
                                a = e.lastIndexOf(w);
                            a < 0 && (a = 0);
                            for (var i = 0; i < a; ++i) e.charCodeAt(i) >= 128 && j("not-basic"), t.push(e.charCodeAt(i));
                            for (var c = a > 0 ? a + 1 : 0; c < r;) {
                                for (var u = n, d = 1, l = h;; l += h) {
                                    c >= r && j("invalid-input");
                                    var y = C(e.charCodeAt(c++));
                                    (y >= h || y > O((f - n) / d)) && j("overflow"), n += y * d;
                                    var v = l <= s ? p : l >= s + m ? m : l - s;
                                    if (y < v) break;
                                    var b = h - v;
                                    d > O(f / b) && j("overflow"), d *= b
                                }
                                var _ = t.length + 1;
                                s = A(n - u, _, 0 == u), O(n / _) > f - o && j("overflow"), o += O(n / _), n %= _, t.splice(n++, 0, o)
                            }
                        ...
                        R = function(e) {
                            ...
                            for (y && t.push(w); v < r;) {
                                ...
                                var C = v + 1;
                                b - n > O((f - o) / C) && j("overflow"), o += (b - n) * C, n = b;
                                var D = !0,
                                    R = !1,
                                    M = void 0;
                                try {
                                    for (var U, L = e[Symbol.iterator](); !(D = (U = L.next()).done); D = !0) {
                                        var F = U.value;
                                        if (F < n && ++o > f && j("overflow"), F == n) {
                                            for (var z = o, q = h;; q += h) {
                                                var V = q <= s ? p : q >= s + m ? m : q - s;
                                                if (z < V) break;
                                                var K = z - V,
                                                    H = h - V;
                                                t.push(k(I(V + K % H, 0))), z = O(K / H)
                                            }
                                            t.push(k(I(z, 0))), s = A(o, C, v == y), o = 0, ++v
                                        }
                                    }
                                } catch (e) {
                                    R = !0, M = e
                    ...
                    function W(e) {
                        ...
                        if (o) {
                            ...
                            var s = F[(t.scheme || r.scheme || "").toLowerCase()];
                            if (t.unicodeSupport || s && s.unicodeSupport) V(r, n);
                            else {
                                if (r.host && (t.domainHost || s && s.domainHost)) try {
                                    r.host = L.toASCII(r.host.replace(n.PCT_ENCODED, q).toLowerCase())
                                } catch (e) {
                    ...
                    function re(e) {
                        var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
                            r = t.iri ? u : c,
                            n = [],
                            o = F[(t.scheme || e.scheme || "").toLowerCase()];
                        if (o && o.serialize && o.serialize(e, t), e.host)
                            if (r.IPV6ADDRESS.test(e.host));
                            else if (t.domainHost || o && o.domainHost) try {
                            e.host = t.iri ? L.toUnicode(e.host) : L.toASCII(e.host.replace(r.PCT_ENCODED, q).toLowerCase())
                        } catch (r) {
                    ...
                    function ce(e, t) {
                        return e && e.toString().replace(t && t.iri ? u.PCT_ENCODED : c.PCT_ENCODED, q)
                    }
                    var ue = {
                            scheme: "http",
                            domainHost: !0,
                    ...
                    var ke = {
                            ...
                            serialize: function(e, t) {
                                ...
                                var h = [];
                                for (var p in f) f[p] !== pe[p] && h.push(p.replace(_e, Oe).replace(_e, o).replace(Se, z) + "=" + f[p].replace(_e, Oe).replace(_e, o).replace(Pe, z));
                    ...
                    F[ue.scheme] = ue, F[de.scheme] = de, F[fe.scheme] = fe, F[he.scheme] = he, F[ke.scheme] = ke, F[Ne.scheme] = Ne, F[xe.scheme] = xe, e.SCHEMES = F, e.pctEncChar = z, e.pctDecChars = q, e.parse = W, e.removeDotSegments = te, e.serialize = re, e.resolveComponents = ne, e.resolve = oe, e.normalize = se, e.equal = ae, e.escapeComponent = ie, e.unescapeComponent = ce, Object.defineProperty(e, "__esModule", {
                        value: !0
                    })
                }(t)
            },
            ...
            6783: (e, t, r) => {
                ...
                function p(e, t = []) {
                    if (!s(e) && !(0, o.Kn)(e)) {
                        const r = (0, o.X6)(e);
                        throw new d(`should be a directive object but it is ${P(r)} ${r}`, t)
                    }
                ...
                function m(e, t = []) {
                    ...
                    switch (r) {
                        ...
                        case "null":
                            return;
                        default:
                            throw new d(`should be a mapping directive or a JSON value but it is ${P(r)} ${r}`, t)
                    }
                }
                ...
                function y(e, t = []) {
                    ...
                    switch (r) {
                        ...
                        case "string":
                            return;
                        default:
                            throw new d(`should be a string or a mapping directive but it is ${P(r)} ${r}`, t)
                    }
                }
                ...
                function $(e, t = []) {
                    const r = f(e);
                    if ("string" !== r) throw new d(`should be a string but it is ${P(r)} ${r}`, t)
                }

                function w(e, t = []) {
                    const r = f(e);
                    if ("boolean" !== r) throw new d(`should be a boolean but it is ${P(r)} ${r}`, t)
                }

                function b(e, t = []) {
                    const r = f(e);
                    if ("object" !== r) throw new d(`should be an object but it is ${P(r)} ${r}`, t);
                    const n = e,
                        o = Object.keys(n),
                ...
                function E(e, t = []) {
                    const r = (0, o.X6)(e);
                    if ("array" !== r) throw new d(`should be an array but it is ${P(r)} ${r}`, t)
                }
                ...
                T("@replace", ((e, t) => {
                    ...
                    if (e.value) {
                        ...
                        if ("string" == typeof o && "string" == typeof r && "string" == typeof n && "boolean" == typeof s && "boolean" == typeof a) {
                            ...
                            if (n.length > 10) throw new Error('@replace requires a "replacement" less than 10 characters');
                            r = r.replace(/[-[\]{}()*+?.,\\^$|#\s]/g, "\\$&");
                            let e = "";
                    ...
                    const [r, s] = e, a = "string" == typeof r ? (0, n.U)(t, r.replace("$.", "")) : A(r, t);
                    return ["object", "array"].includes((0, o.X6)(a)) && "object" === (0, o.X6)(s) && Object.keys(s).length > 0 ? k(a).map((e => A(s, e))) : a
                })), x("@path", ((e, t) => (0, n.U)(t, e.replace("$.", "")))), x("@template", ((e, t) => function(e, t = {}) {
            ...
            9143: (e, t, r) => {
                ...
                t.CodeGen = class {
                    ...
                    try (e, t, r) {
                        ...
                        return r && (this._currNode = n.finally = new j, this.code(r)), this._endBlockNode(k, j)
                    }
                    throw (e) {
                ...
                function E(e, t, r, n) {
                    ...
                    function y(h) {
                        ...
                        (function(e, t) {
                            ...
                            t.forEach((t => {
                                O(e.dataTypes, t) || k(e, `type "${t}" not allowed by context "${e.dataTypes.join(",")}"`)
                        ...
                        ! function(e, t) {
                            ...
                            for (const n in r) {
                                ...
                                if ("object" == typeof o && (0, s.shouldUseRule)(e.schema, o)) {
                                    ...
                                    r.length && !r.some((e => P(t, e))) && k(e, `missing type "${r.join(",")}" for keyword "${n}"`)
                                }
                            }
                        }(e, e.dataTypes)
                    }(e, t), o.block((() => {
            ...
            3993: (e, t, r) => {
                ...
                class $ {
                    ...
                    addKeyword(e, t) {
                        ...
                        if (j.call(this, r, t), !t) return (0, f.eachItem)(r, (e => N.call(this, e))), this;
                        x.call(this, t);
                        const n = { ...t,
    ...
    }, o.f = {}, o.e = e => Promise.all(Object.keys(o.f).reduce(((t, r) => (o.f[r](e, t), t)), [])), o.u = e => e + "/909319ad4a6af2ed4035.js", o.g = function() {
    ...
    (() => {
        ...
        for (var A = 256, D = []; A--;) D[A] = (A + 256).toString(16).substring(1);
        ...
        o(7128);
        const M = function(e) {
            const t = async t => (await o.e(962).then(o.bind(o, 3962))).generatePlugins(e, t, t.subscriptions || []);
...
//# sourceMappingURL=4e11bf9a86f14566bc69.js.map