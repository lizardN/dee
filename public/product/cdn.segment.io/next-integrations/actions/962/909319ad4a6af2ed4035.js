    ...
    [962], {
        ...
        6783: (e, t, r) => {
            ...
            function d(e, t = []) {
                if (!s(e) && !(0, o.Kn)(e)) {
                    const r = (0, o.X6)(e);
                    throw new p(`should be a directive object but it is ${_(r)} ${r}`, t)
                }
            ...
            function y(e, t = []) {
                ...
                switch (r) {
                    ...
                    case "null":
                        return;
                    default:
                        throw new p(`should be a mapping directive or a JSON value but it is ${_(r)} ${r}`, t)
                }
            }
            ...
            function v(e, t = []) {
                ...
                switch (r) {
                    ...
                    case "string":
                        return;
                    default:
                        throw new p(`should be a string or a mapping directive but it is ${_(r)} ${r}`, t)
                }
            }
            ...
            function m(e, t = []) {
                const r = h(e);
                if ("string" !== r) throw new p(`should be a string but it is ${_(r)} ${r}`, t)
            }

            function b(e, t = []) {
                const r = h(e);
                if ("boolean" !== r) throw new p(`should be a boolean but it is ${_(r)} ${r}`, t)
            }

            function x(e, t = []) {
                const r = h(e);
                if ("object" !== r) throw new p(`should be an object but it is ${_(r)} ${r}`, t);
                const n = e,
                    o = Object.keys(n),
            ...
            function k(e, t = []) {
                const r = (0, o.X6)(e);
                if ("array" !== r) throw new p(`should be an array but it is ${_(r)} ${r}`, t)
            }
            ...
            function I(e, t) {
                if (!A.exec(e)) throw new Error(`"${e}" is an invalid directive name`);
                j[e] = t
            }
            ...
            I("@if", ((e, t) => {
                ...
                return r && void 0 !== e.then ? q(e.then, t) : !r && e.else ? q(e.else, t) : void 0
            })), I("@case", ((e, t) => {
            ...
            function q(e, t) {
                ...
                if (Array.isArray(e)) return e.map((e => q(e, t)));
                const r = {};
                for (const n of Object.keys(e)) r[n] = q(e[n], t);
                return r
            }
            ...
            I("@replace", ((e, t) => {
                ...
                const [r, s] = e, a = "string" == typeof r ? (0, n.U)(t, r.replace("$.", "")) : q(r, t);
                return ["object", "array"].includes((0, o.X6)(a)) && "object" === (0, o.X6)(s) && Object.keys(s).length > 0 ? S(a).map((e => q(s, e))) : a
            })), N("@path", ((e, t) => (0, n.U)(t, e.replace("$.", "")))), N("@template", ((e, t) => function(e, t = {}) {
        ...
        6146: (e, t, r) => {
            ...
            const O = {
                ...
                S = e => "string" === e.type ? e.value.replace(/^"/, "").replace(/"$/, "") : "number" === e.type ? Number(e.value) : "ident" === e.type && ["true", "false"].includes(e.value) ? "true" === e.value : String(e.value),
                j = e => "ident" === e.type && ["contains", "match"].includes(e.value),
                A = (e, t, r, {
                    negate: n
                } = {
                    negate: !1
                    ...
                    if ("match" === e) {
                        ...
                        let s, a;
                        r.shift(), o.value.endsWith('*"') ? (s = n ? "not_starts_with" : "starts_with", a = String(S(o)).slice(0, -1)) : (s = n ? "not_ends_with" : "ends_with", a = String(S(o)).slice(1)), ["event", "name", "userId"].includes(e.value) && t.push({
                            type: e.value,
                            operator: s,
                            value: a
                        }), /^(properties)/.test(e.value) && t.push({
                ...
                I = e => {
                    ...
                    for (; s && "eos" !== s.type;) {
                        ...
                        if ("operator" === s.type && "!" === s.value && j(e[0])) {
                            const t = e[0].value;
                            e.shift(), A(t, r, e, {
                                negate: !0
                            })
...
//# sourceMappingURL=909319ad4a6af2ed4035.js.map