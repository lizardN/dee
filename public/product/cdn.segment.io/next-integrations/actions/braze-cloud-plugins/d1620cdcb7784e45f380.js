(() => {
    ...
    }(), o.o = (e, t) => Object.prototype.hasOwnProperty.call(e, t), e = {}, t = "Destination:", o.l = (r, n, i, a) => {
        if (e[r]) e[r].push(n);
        else {
            var s, u;
            if (void 0 !== i)
                for (var d = document.getElementsByTagName("script"), l = 0; l < d.length; l++) {
                    var c = d[l];
                    if (c.getAttribute("src") == r || c.getAttribute("data-webpack") == t + i) {
                        s = c;
                        break
                    }
                }
            s || (u = !0, (s = document.createElement("script")).charset = "utf-8", s.timeout = 120, o.nc && s.setAttribute("nonce", o.nc), s.setAttribute("data-webpack", t + i), s.src = r), e[r] = [n];
            var f = (t, n) => {
    ...
    const s = function(e) {
        ...
        actions: {
            debouncePlugin: {
                ...
                perform: (e, t) => {
                    const r = t.context.event,
                        n = t.analytics.user(),
                        o = t.context,
                        i = function(e) {
                            if (e.userId && e.userId !== a.id) return !0;
                            if (e.anonymousId && e.anonymousId !== a.anonymousId) return !0;
                            const t = e.traits ? ? {};
                            return JSON.stringify(a.traits) !== JSON.stringify(t)
                        }(r);
                    o.updateEvent("integrations.Braze Web Mode (Actions)", i), o.updateEvent("integrations.Braze Cloud Mode (Actions)", i), o.updateEvent("integrations.Appboy", i), a.id = n.id(), a.anonymousId = n.anonymousId(), a.traits = n.traits()
                }
            }
        }
    });
    window["braze-cloud-pluginsDestination"] = i.default
})();
//# sourceMappingURL=d1620cdcb7784e45f380.js.map