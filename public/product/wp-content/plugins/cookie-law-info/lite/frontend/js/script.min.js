! function(e) {
    ...
    function y() {
        v(), !0 === n._bannerConfig.config.revisitConsent.status && T()
    }
    ...
    function f() {
        ...
        function() {
            ...
            })(t), document.body.insertAdjacentHTML("afterbegin", t.body.innerHTML), "classic" === b() && p("=settings-button", "false");
            N(),
                function() {
                ...
                function() {
                    ...
                    a("=settings-button", () => x("settings-button")), a("=detail-close", () => w()), a("=optout-cancel-button", () => w()), a("=close-button", () => (c._ckySetInStore("action", "yes"), void y())), a("=donotsell-button", () => x("donotsell-button")), a("=reject-button", P("reject")), a("=accept-button", P("all")), a("=detail-accept-button", P("all")), a("=detail-save-button", P()), a("=detail-category-preview-save-button", P()), a("=optout-confirm-button", P()), a("=detail-reject-button", P("reject")), a("=revisit-consent", () => _revisitCkyConsent()), a("=optout-close", () => w())
                }(),
                function() {
                    ...
                    ! function(e, t, {
                        ...
                        if (e.checked = n, e.disabled = o, e.style.backgroundColor = n ? r : s, D(e, n, t, i), !c) return;
                        e.addEventListener("change", ({
                            currentTarget: n
                        }) => {
                            const o = n.checked;
                            n.style.backgroundColor = o ? r : s, D(e, o, t, i)
                        })
                ...
                function() {
                    ...
                    const [n, o] = j("ccpa" === e ? "optout-popup" : "detail");
                    I(n, o, !0), I(o, n)
                }(),
                function() {
                    const e = "ccpa" === m() ? i("optout-popup") : i("detail");
                    if (!e) return !1;
                    const t = e.closest(".cky-modal");
                    if (!t) return !1;
                    if ("pushdown" !== _() && "popup" !== _()) {
    ...
    async function g() {
        try {
            f(),
                function() {
                    for (const e of n._categories) "yes" !== c._ckyGetFromStore(e.slug) && M(e)
    ...
    function _() {
        return "classic" === b() ? "pushdown" : n._bannerConfig.settings.preferenceCenterType
    }
    ...
    function S() {
        if ("classic" === b()) return h();
        let e = "ccpa" === m() ? i("optout-popup") : i("detail");
        return e && e.closest(".cky-modal") || !1
    }

    function w() {
        const e = S();
        e && e.classList.remove(E()), "classic" !== b() ? (! function() {
            const e = document.querySelector(".cky-overlay");
            e && e.classList.add("cky-hide")
        }(), c._ckyGetFromStore("action") || C()) : (p("=settings-button", "false"), u("=notice", "cky-consent-bar-expand")), c._ckyGetFromStore("action") && T();
    ...
    function L() {
        const e = S();
        e && e.classList.add(E()), "classic" !== b() ? (! function() {
            const e = document.querySelector(".cky-overlay");
            e && e.classList.remove("cky-hide")
        }(), v()) : (p("=settings-button"), function() {
            l("add", ...arguments)
    ...
    function $() {
        const e = S();
        e && e.classList.toggle(E()), "pushdown" !== _() && function() {
            const e = document.querySelector(".cky-overlay");
    ...
    function E() {
        return "pushdown" === _() ? "cky-consent-bar-expand" : "cky-modal-open"
    }
    ...
    function x(e = !1) {
        n._preferenceOriginTag = e, "classic" === b() ? ($(), p("=settings-button")) : L()
    }
    ...
    function N(e = !1) {
        for (const t of n._categories) {
            ...
            O(t, "yes" === o || !o && t.defaultConsent[m()] || t.isNecessary, t.isNecessary, n._shortCodes.find(e => "cky_category_toggle_label" === e.key).content.replace("[cky_preference_{{category_slug}}_title]", t.name), e), q(t)
        }
    }

    function O(e, t, o, c, r = !1) {
        ...
        ["ckyCategoryDirect", "ckySwitch"].map(s => {
            ...
            u && (! function(e, t = {}, o = !1) {
                ...
                "detail-category-toggle" === e.parentElement.getAttribute("data-cky-tag") ? function(e, t) {
                    ...
                    t.isNecessary ? c && c.remove() : (r && r.remove(), ("classic" === b() && n._bannerConfig.config.categoryPreview.status || t.cookies && 0 === t.cookies.length) && c && c.remove())
            ...
            }(u, e, r), u.checked = t, u.disabled = o, u.style.backgroundColor = t ? i : a, D(u, t, c), r || u.addEventListener("change", ({
                currentTarget: e
            }) => {
                const t = e.checked;
                e.style.backgroundColor = t ? i : a, D(u, t, c)
            }))
        })
    }
        ...
        return () => {
            ! function(e = "all") {
                ...
                for (const s of n._categories) {
                    let n = "no";
                    n = "gdpr" === t ? s.isNecessary || "reject" !== e && ("custom" !== e || K(s.slug)) ? "yes" : "no" : o && !s.defaultConsent.ccpa ? "no" : "yes", c._ckySetInStore("" + s.slug, n), "no" === n ? (r.rejected.push(s.slug), M(s)) : r.accepted.push(s.slug)
                }
                H()
            }(e), y(), w(),
                function() {
    ...
    }, "undefined" != typeof document && ("complete" !== document.readyState && "interactive" !== document.readyState ? document.addEventListener("DOMContentLoaded", k) : k());
    const B = document.createElement;

    function H() {
        if (1 === navigator.doNotTrack) return;
        const e = c._ckyGetFromStore("consent");
        ("gdpr" !== m() || e && "yes" === e) && (n._backupNodes = n._backupNodes.filter(({
            position: e,
            node: t,
            uniqueID: n
        }) => {
    ...
    document.createElement = (...e) => {
        ...
        return Object.defineProperties(t, {
            src: {
                ...
                set: function(e) {
                    return W(t, e) && n("type", "javascript/blocked"), n("src", e), !0
                }
            },
            type: {
                get: function() {
                ...
                set: function(e) {
                    return e = W(t) ? "javascript/blocked" : e, n("type", e), !0
                }
            }
        }), t.setAttribute = (e, o) => {
            if ("type" === e || "src" === e) return t[e] = o;
            n(e, o), "data-cookieyes" !== e || W(t) || n("type", "text/javascript")
        }, t
    };
    const F = new MutationObserver((function(e) {
        for (const {
                addedNodes: t
            } of e)
            for (const e of t)
                if (e.src && e.nodeName && ["script", "iframe"].includes(e.nodeName.toLowerCase())) try {
                    const t = e.src.startsWith("//") ? `${window.location.protocol}${e.src}` : e.src,
                        ...
                        s = `${o}${r}`.replace(/^www./, "");
                    if (G(e, s), !U(s)) continue;
                    const i = c._ckyRandomString(8, !1);
                    if ("iframe" === e.nodeName.toLowerCase()) Q(e, i);
                    else {
    ...
    function U(e) {
        ...
        return t && t.categories.some(e => R(e))
    }

    function W(e, t) {
        return e.hasAttribute("data-cookieyes") && R(e.getAttribute("data-cookieyes").replace("cookieyes-", "")) || U(t || e.src)
    }
